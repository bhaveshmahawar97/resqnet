...
async function main() {
  ...
  const { getCoreModels, getAiModels, CORE_COLLECTIONS, AI_COLLECTIONS } = await import("../../server/models/index.js");
  ...
  const { User, RescueRequest, DispatchLog, MissionHistory, AIScan } = await import("../../server/models/index.js");
  ...
  try {
    const { buildTimelineEntry } = await import("../../server/services/rescueService.js");
    ...
    const { recordDispatchEvent, recordMissionHistory } = await import("../../server/services/dispatchService.js");
