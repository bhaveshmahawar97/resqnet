/*
 * Bulk NGO + User seed script
 * Run from repo root: `node scripts/dev/seed_ngos_bulk.js`
 */
...
const { registerUser, generateToken } = await import("../server/services/authService.js");
...
async function run() {
  console.log("🚀 Starting bulk NGO + user seed...");
