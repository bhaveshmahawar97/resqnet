  ...
  if (config.requiresVerification) {
    ...
    const renderVerificationState = () => {
      ...
      if (ngoProfile.verificationStatus === "pending") {
        return (
          <div style={{ maxWidth: 600, margin: "3rem auto", textAlign: "center" }}>
            <div style={{ width: 64, height: 64, background: "#F3E8FF", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1.5rem", fontSize: "2rem" }}>⏳</div>
      ...
      if (ngoProfile.verificationStatus === "under_review") {
        return (
          <div style={{ maxWidth: 600, margin: "3rem auto", textAlign: "center" }}>
            <div style={{ width: 64, height: 64, background: "#DBEAFE", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1.5rem", fontSize: "2rem" }}>🔍</div>
      ...
      if (ngoProfile.verificationStatus === "rejected") {
        return (
          <div style={{ maxWidth: 600, margin: "3rem auto", textAlign: "center" }}>
            <div style={{ width: 64, height: 64, background: "#FEE2E2", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1.5rem", fontSize: "2rem" }}>❌</div>
      ...
      if (ngoProfile.verificationStatus === "suspended") {
        return (
          <div style={{ maxWidth: 600, margin: "3rem auto", textAlign: "center" }}>
            <div style={{ width: 64, height: 64, background: "#FEF3C7", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1.5rem", fontSize: "2rem" }}>⚠️</div>
