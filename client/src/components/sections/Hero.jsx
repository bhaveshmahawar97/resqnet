...
export default function Hero() {
  ...
  const badges = ["AI Diagnostics", "Live Rescue Alerts", "300+ NGOs"];
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
        ...
        />
        {/* Gradient overlay — stronger on edges */}
        <div
          style={{
            position: "absolute",
            inset: 0,
      ...
      {/* Content — centered with fluid padding */}
      <motion.div
        style={{
          y: parallaxY,
          opacity: heroOp,
      ...
      >
        ...
        {/* Headline — fluid clamp across all viewport widths */}
        <motion.h1
