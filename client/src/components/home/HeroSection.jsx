      ...
      >
        ...
        >
          ...
          <span style={{
            ...
            AI-Powered Rescue Coordination Platform
          </span>
        </motion.div>
        ...
        >
          Rescue.{" "}
          <span style={{ color: T.accent }}>Heal.</span>{" "}
          Rehome.
        </motion.h1>
        ...
        >
          India's first AI-powered animal rescue platform — connecting NGOs, veterinary clinics, and responders for faster, smarter emergency care.
        </motion.p>
