  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Find Your{" "}
          <span style={{ color: T.accent }}>Perfect Match.</span>
        </motion.h1>
        ...
        >
          Browse rescued animals across India — dogs, cats, birds, and more — matched to your lifestyle through AI compatibility scoring.
        </motion.p>
        ...
        >
          <Button variant="primary" size="lg">Browse Animals</Button>
